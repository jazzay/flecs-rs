...
struct Attack { value: f32 }

#[derive(Copy, Clone, Default, Debug, PartialEq)]
struct Defense { value: f32 }

#[derive(Copy, Clone, Default, Debug, PartialEq)]
struct FreightCapacity { value: f32 }

#[derive(Copy, Clone, Default, Debug, PartialEq)]
struct ImpulseSpeed { value: f32 }
...
fn main() {
    ...
    let spaceship = world.prefab("Spaceship")
        ...
        let freighter = world.prefab("Freighter")
            ...
            let mammoth_freighter = world.prefab("MammothFreighter")
                .is_a(freighter)
